    ...
    <section className='bg-richblack-800 relative h-[500px]'>
        <div className='w-11/12 mx-auto mt-24 flex flex-col gap-3 justify-center items-center '>
            <div className='lg:max-w-[80%]'>
                ...
                <p className='text-sm font-semibold text-richblack-500 mt-4 text-center'>CodeCatalyst is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
            </div>
