        ...
        <div className='bg-pure-greys-5 text-richblack-700 '>
            ...
            <div className='w-11/12 max-w-maxContent mt-32 flex flex-col lg:flex-row gap-x-[11rem] gap-y-4 justify-center mx-auto'>
              ...
              <div className='flex flex-col gap-y-10 '>
                <div className='text-richblack-700 text-md'>The modern CodeCatalyst  is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.</div>
                <div className='w-fit'>
