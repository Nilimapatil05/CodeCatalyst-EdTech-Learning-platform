...
exports.signUp = async(req,res)=> {
    ...
    try{
        // fetch details field by user in signup page
...
exports.login = async (req,res)=> {
    try
    {
        ...
        const options= {httpsOnly: true, expiresIn: '48h'}
...
exports.changePassword = async (req, res) => {
    try
    {
        ...
        const response = await mailSender(email, "TechGYAN - Password Changed", body);
